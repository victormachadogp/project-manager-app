<template>
  <div class="relative h-[231px]">
    ...
    <div class="absolute bottom-0 right-0 m-3 flex justify-center items-center gap-5">
      ...
      <button
        @click="emit('updateShowOptions', !showOptions)"
...
const { project, imageUrl, showOptions } = defineProps<{
  project: Project
  imageUrl: string
  showOptions: boolean
}>()
...
const emit = defineEmits<{
  ...
  (e: 'updateShowOptions', value: boolean): void
  (e: 'handleImageError', event: Event): void
  (e: 'delete'): void
}>()
